...
(population INTEGER,
 ...
 city_name CHAR(40),
 zipcode CHAR(5)
 PRIMARY KEY(city_name, zipcode, created_time)
);

CREATE TABLE State_city
(city_name CHAR(40),
 zipcode CHAR(5),
 created_name TIMESTAMP,
 state_name CHAR(40),
...
(id INTEGER,
 ...
 PRIMARY KEY(facility_id, patient_id, admission_date),
...
(facility_id CHAR(10),
 ...
 state_name CHAR(40),
 PRIMARY KEY(facility_id),
 FOREIGN KEY(city_name, state_name) REFERENCES city_state
);
...
(policy_type policy_type,
 details CHAR(3000),
 state_name CHAR(40),
 PRIMARY KEY(state_name, created_time, topic),
 FOREIGN KEY(state_name) REFERENCES US_state
  	ON DELETE CASCADE 
);
...
(policy_created_time TIMESTAMP,
 ...
 username CHAR(30),
 id INTEGER,
 PRIMARY KEY(state_name, created_time, topic, id, username),
 FOREIGN KEY(state_name, policy_created_time, topic) REFERENCES State_policy,
 FOREIGN KEY(id, username) REFERENCES User_comment
);
